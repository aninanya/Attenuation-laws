...
//					else {
//
//						Soil[k] = log10(pow(e, valuesT8.at(i).at(0)*log(V30 / 760.0) + bnl.at(i) * log((AT0.at(j).at(k)) / 100.0)));
//
//					}
...
//					else {
//
//						S = log10(pow(e, valuesT8.at(i).at(0)*log(V30 / 760.0) + bnl.at(i) * log((AT0.at(j).at(k)) / 100.0)));
//
//					}
//					//cout << S << endl;
//					Rcd = distances[k];
